...
export const ALL_APPLICATIONS = [
  { id: 'A01', candidate: 'Amit Kumar', job: 'Senior React Developer', company: 'Google', date: 'May 22, 2026', status: 'Screening', experience: '4 years', location: 'Bangalore', expectedSalary: '₹35-45 LPA', noticePeriod: '30 days', skills: ['React', 'TypeScript', 'Node.js', 'Redux'], resumeUrl: 'https://example.com/resume-amit.pdf', coverLetter: 'I am excited to apply for the Senior React Developer position. With 4 years of experience in frontend development and expertise in React and TypeScript, I am confident in my ability to contribute to your team.' },
  { id: 'A02', candidate: 'Sneha Rao', job: 'UI/UX Designer', company: 'Zomato', date: 'May 21, 2026', status: 'Applied', experience: '3 years', location: 'Gurgaon', expectedSalary: '₹20-28 LPA', noticePeriod: '15 days', skills: ['Figma', 'UI Design', 'Prototyping', 'Wireframing'], resumeUrl: 'https://example.com/resume-sneha.pdf', coverLetter: 'As a passionate UI/UX designer with 3 years of experience, I have a proven track record of creating user-centric designs that enhance user engagement and satisfaction.' },
  { id: 'A03', candidate: 'Rahul Verma', job: 'Backend Engineer', company: 'Microsoft', date: 'May 20, 2026', status: 'Rejected', experience: '6 years', location: 'Bangalore', expectedSalary: '₹40-55 LPA', noticePeriod: '60 days', skills: ['Docker', 'Kubernetes', 'Python', 'AWS'], resumeUrl: 'https://example.com/resume-rahul.pdf', coverLetter: 'With 6 years of backend development experience, I have successfully led infrastructure improvements and scalability initiatives.' },
  { id: 'A04', candidate: 'Pooja Hegde', job: 'Data Scientist', company: 'Amazon', date: 'May 19, 2026', status: 'Applied', experience: '4 years', location: 'Hyderabad', expectedSalary: '₹38-50 LPA', noticePeriod: '30 days', skills: ['Python', 'Machine Learning', 'SQL', 'TensorFlow'], resumeUrl: 'https://example.com/resume-pooja.pdf', coverLetter: 'I am enthusiastic about leveraging my data science expertise and machine learning skills to solve complex business problems.' },
  { id: 'A05', candidate: 'Vikas Khanna', job: 'Product Manager', company: 'Swiggy', date: 'May 18, 2026', status: 'Screening', experience: '5 years', location: 'Delhi', expectedSalary: '₹35-50 LPA', noticePeriod: 'Immediate', skills: ['Product Strategy', 'Agile', 'Analytics', 'Leadership'], resumeUrl: 'https://example.com/resume-vikas.pdf', coverLetter: 'With 5 years of product management experience, I have successfully launched multiple features that increased user engagement by 40%.' },
];

// Applications for Stryper's own internal job postings (from Careers page)
export const STRYPER_APPLICATIONS = [
  { id: 'SA01', candidate: 'Arjun Mehta', job: 'HR Manager', date: 'Jun 5, 2026', status: 'Applied', experience: '5 years', location: 'Delhi', phone: '+91 98001 11111', expectedSalary: '₹18-24 LPA', noticePeriod: '30 days', skills: ['HR Strategy', 'Recruitment', 'Employee Relations'], resumeUrl: 'https://example.com/resume-arjun.pdf', coverLetter: 'I am interested in the HR Manager position and eager to contribute to talent development and organizational growth.' },
  { id: 'SA02', candidate: 'Divya Sharma', job: 'Operations Executive', date: 'Jun 4, 2026', status: 'Screening', experience: '3 years', location: 'Gurgaon', phone: '+91 98001 22222', expectedSalary: '₹12-16 LPA', noticePeriod: '15 days', skills: ['Operations', 'Process Improvement', 'Supply Chain'], resumeUrl: 'https://example.com/resume-divya.pdf', coverLetter: 'As an operations professional, I have optimized processes and improved efficiency across multiple teams.' },
  { id: 'SA03', candidate: 'Karan Singh', job: 'HR Manager', date: 'Jun 3, 2026', status: 'Interview', experience: '7 years', location: 'Noida', phone: '+91 98001 33333', expectedSalary: '₹22-30 LPA', noticePeriod: '60 days', skills: ['HR Management', 'Recruitment', 'Payroll', 'Performance Management'], resumeUrl: 'https://example.com/resume-karan.pdf', coverLetter: 'With 7 years of HR experience, I have successfully managed recruitment initiatives that improved hiring efficiency by 35%.' },
  { id: 'SA04', candidate: 'Neha Joshi', job: 'Operations Executive', date: 'Jun 2, 2026', status: 'Rejected', experience: '2 years', location: 'Delhi', phone: '+91 98001 44444', expectedSalary: '₹10-14 LPA', noticePeriod: 'Immediate', skills: ['Operations', 'Logistics', 'Coordination'], resumeUrl: 'https://example.com/resume-neha.pdf', coverLetter: 'I am seeking an operations role to apply my analytical skills and drive operational excellence.' },
  { id: 'SA05', candidate: 'Rohit Gupta', job: 'HR Manager', date: 'Jun 1, 2026', status: 'Applied', experience: '4 years', location: 'Gurugram', phone: '+91 98001 55555', expectedSalary: '₹16-22 LPA', noticePeriod: '30 days', skills: ['HR Operations', 'Training', 'Compliance'], resumeUrl: 'https://example.com/resume-rohit.pdf', coverLetter: 'I am confident that my HR expertise and passion for employee development make me an ideal fit for your team.' },
];

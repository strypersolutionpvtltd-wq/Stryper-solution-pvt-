...
import { Smartphone, ArrowLeft, RefreshCw, Edit2 } from 'lucide-react';
...
const PhoneVerification = () => {
  ...
  // Use mock phone from state or default mock
  const phone = location.state?.phone || '+91 ******4521';
  ...
  const handleVerify = (e) => {
    ...
    setTimeout(() => {
      ...
      if (code === '123456') {
        ...
        toast.error('Invalid verification code. Try "123456" for testing.');
        setError(true);
      }
    }, 1500);
  };
      ...
      >
        <div className="bg-white py-10 px-6 shadow-xl border border-neutral-100 rounded-3xl sm:px-10">
          <div className="flex flex-col items-center text-center mb-8">
            ...
            <h2 className="text-2xl font-extrabold text-neutral-900 tracking-tight">Verify Your Phone</h2>
            ...
            <div className="flex items-center gap-2 mt-1.5 bg-neutral-50 border border-neutral-100 px-3 py-1 rounded-full">
              <span className="text-xs font-bold text-neutral-700">{phone}</span>
              <button 

...
const OVERVIEW_CARDS = [
  { id: "manpower",  title: "Industrial Manpower",            description: "Industrial Manpower: We find skilled, semi-skilled, and even entry-level workers for factories, production lines, and plant operations. Everyone we send is thoroughly checked and ready to start.", icon: <ManpowerIcon />,  href: "/services/industrial-manpower"  },
  { id: "logistics", title: "Logistics & Warehouse Staffing", description: "Logistics and Warehouse Staff: We provide all the staff you need for warehouses, your supply chain, and even last-mile deliveries, making sure your operations run smoothly without a hitch.", icon: <LogisticsIcon />, href: "/services/logistics-warehouse"  },
  { id: "facility",  title: "Facility Management",            description: "Taking Care of Your Facilities: This includes things like cleaning, security, maintenance, and other support services. Our teams are trained and supervised to do a great job.", icon: <FacilityIcon />,  href: "/services/facility-management"   },
  { id: "payroll",   title: "Payroll & Compliance",           description: "Payroll and Legal Stuff: We handle everything related to payroll, from processing salaries to making sure all the necessary contributions like PF, ESI, PT, and TDS are managed correctly and on time.", icon: <PayrollIcon />,   href: "/services/payroll-compliance"    },
];

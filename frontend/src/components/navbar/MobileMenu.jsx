        ...
        >
          {isLoggedIn ? (
            <div className="space-y-3">
              <Link
                to={userRole === 'candidate' ? '/career-hub' : userRole === 'company' ? '/hire-zone' : '/admin'}
                onClick={onClose}
                className="flex items-center justify-center w-full py-3.5 rounded-xl text-white text-sm font-semibold transition-colors duration-200"
              ...
              <button
                ...
                className="w-full py-3.5 rounded-xl border-2 text-sm font-semibold transition-colors duration-200"

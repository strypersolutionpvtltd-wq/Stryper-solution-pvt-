            ...
            <div className="flex-1 p-6 space-y-6">
              ...
              <div className="flex items-center gap-4">
                ...
                <div className="flex-1 min-w-0">
                  <h3 className="text-lg font-bold text-neutral-900 truncate">{applicant.name}</h3>
                  <p className="text-sm text-neutral-500 truncate">{applicant.appliedRole}</p>
                  <div className="mt-1">
              ...
              <div className="bg-neutral-50 rounded-xl p-4 space-y-2.5">
                <div className="flex items-center justify-between mb-3">
                  ...
                  <button
                    ...
                    className="text-[10px] font-bold text-purple-600 bg-purple-50 px-2 py-1 rounded-md hover:bg-purple-100 transition-colors"
                  >
                    View Resume
                  </button>
                </div>

...
const ICONS = {
  ...
  'log-out': <path d="M9 21H5a2 2 0 01-2-2V5a2 2 0 012-2h4M16 17l5-5-5-5M21 12H9" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round" fill="none"/>
};
      ...
      <aside className="w-64 shrink-0">
        ...
        <nav className="bg-white rounded-2xl border border-neutral-100 overflow-hidden shadow-sm">
          ...
          <button
            ...
            className="w-full flex items-center gap-3 px-4 py-3.5 text-sm font-medium text-red-600 hover:bg-red-50 transition-colors duration-150"
          >
            <Icon name="log-out" />
            Sign Out
          </button>
